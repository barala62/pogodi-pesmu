...
import { Share2, Check, X, Disc3, Play, Pause, RotateCw, Sparkles, ExternalLink } from 'lucide-react';
import { Song, GuessAttempt, GameCategory, SongPreviewResponse } from '../types';
